...
%   \end{itemize}
\runsubsection{Pit Rho}
\descript{| Contract Data Scientist}
\location{Present | Remote}
\vspace{\topsep}
\begin{tightemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Projects}
\descript{\href{https://github.com/KMLDS/Xmpanzee}{Finding interesting arXiv articles (Current)}}
\begin{tightemize}
